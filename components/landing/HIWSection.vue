...
import { Card, CardContent, CardHeader, CardTitle } from '~/packages/@core/ui-kit/shadcn-ui';
...
<template>
  <section
    id="howItWorks"
    class="container py-24 text-center sm:py-32"
  >
    ...
    <p class="mx-auto mb-12 mt-4 text-xl text-muted-foreground md:w-3/4">
      ...
      >
        <CardHeader>
          <CardTitle class="grid place-items-center gap-4">
            <Icon :icon="icon" class="text-primary w-14 h-14" /> {{ title }}
          </CardTitle>
        </CardHeader>
