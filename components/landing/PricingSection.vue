...
import { Badge, Button, Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '~/packages/@core/ui-kit/shadcn-ui';
...
<template>
  ...
  >
    ...
    <h3 class="text-xl text-center text-muted-foreground pt-4 pb-8">
      ...
      >
        <CardHeader>
          <CardTitle class="flex item-center justify-between">
            {{ pricing.title }}
            <Badge
              v-if="pricing.popular === PopularPlanType.YES"
              variant="secondary"
        ...
        <CardFooter class="flex">
          <div class="space-y-4">
            <span
              v-for="benefit in pricing.benefitList"
              :key="benefit"
